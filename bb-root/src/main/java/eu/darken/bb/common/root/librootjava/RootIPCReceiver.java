...
public abstract class RootIPCReceiver<T> {
    ...
    static final String BROADCAST_ACTION = "eu.darken.bb.common.root.librootjava.RootIPCReceiver.BROADCAST";
    static final String BROADCAST_EXTRA = "eu.darken.bb.common.root.librootjava.RootIPCReceiver.BROADCAST.EXTRA";
    ...
    public RootIPCReceiver(Context context, int code, Class<T> clazz) {
        ...
        this.code = code;
        handlerThread = new HandlerThread("librootjava:RootIPCReceiver#" + code);
        handlerThread.start();
