...
import eu.darken.bb.common.root.librootjava.Debugger;
...
public class JavaRootHost {
    ...
    public static List<String> getLaunchScript(Context context, String[] params, String[] libs) {
        ...
        return RootJava.getLaunchScript(context, JavaRootHost.class, null, null, paramList.toArray(new String[0]), context.getPackageName() + ":root");
    }
...
//        Timber.setLogTag("librootjava:root");
//        Timber.setDebugLogging(BuildConfig.DEBUG);
//
//        // Setup libsuperuser (required for this example code, but not required to use librootjava in general)
        ...
        Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
            ...
            public void uncaughtException(Thread thread, Throwable throwable) {
                Timber.tag("EXCEPTION").d("%s", throwable.getClass().getName());
                if (oldHandler != null) {
    ...
    private void run(String[] args) {
        ...
        for (int i = usedArgs; i < args.length; i++) {
            ...
            Timber.e("ARGS", "[%d] [%s]", i - usedArgs, args[i]);
        }

        // Grab a (limited) context
        context = RootJava.getSystemContext();

        Timber.d("MAIN SECTION");
    ...
    private void initIPC() {
        ...
        try {
            ...
            */
            ...
            Timber.tag("IPC").d("Non-root process did not connect in a timely fashion");
        }
    }
}