...
class GeneratorBuilder @Inject constructor(
        ...
        private val editors: @JvmSuppressWildcards Map<Backup.Type, SpecGenerator.Editor.Factory<out SpecGenerator.Editor>>
) {
    ...
    data class Data(
            ...
            val editor: SpecGenerator.Editor? = null,
    ...
    fun save(id: UUID): Single<SpecGenerator.Config> = remove(id)
    ...
    fun load(id: UUID): Single<Data> = generatorRepo.configs
    ...
    fun startEditor(configId: UUID = UUID.randomUUID()): Completable = load(configId)
            .onErrorResumeNext {
