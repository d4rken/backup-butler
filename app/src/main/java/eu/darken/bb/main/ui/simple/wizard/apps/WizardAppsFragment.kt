...
import eu.darken.bb.databinding.SimpleModeWizardAppsFragmentBinding
import eu.darken.bb.main.ui.simple.wizard.common.WizardAdapter

@AndroidEntryPoint
class WizardAppsFragment : SmartFragment(R.layout.simple_mode_wizard_apps_fragment) {

    private val vdc: WizardAppsFragmentVDC by viewModels()
    private val ui: SimpleModeWizardAppsFragmentBinding by viewBinding()
