...
@AndroidEntryPoint
class SourcesFragment : SmartFragment(R.layout.task_editor_backup_generators_fragment), GeneratorPickerListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupGeneratorPickerListener {
            vdc.onSourceAdded(it)
        }
    }
    ...
    companion object {
        val TAG = logTag("Backup", "Editor", "Sources", "Fragment")
    }
}
