...
class RepoListFragment : SmartFragment(), AutoInject {
    companion object {
        fun newInstance(): Fragment = RepoListFragment()
    }

    @Inject lateinit var vdcSource: VDCSource.Factory
    private val vdc: RepoListFragmentVDC by vdcs { vdcSource }

    @Inject lateinit var adapter: RepoListAdapter

    @BindView(R.id.recyclerview) lateinit var recyclerView: RecyclerView

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val layout = inflater.inflate(R.layout.repolist_fragment, container, false)
